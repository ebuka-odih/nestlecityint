...
<head>
    ...
    <title>Nestlecity International | New Account</title>
</head>
<body>
...
<nav class="navbar navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('index') }}"> <h1 style="font-weight: bolder; color: #0079c1">Nestlecity International</h1></a>
    </div>
</nav>
